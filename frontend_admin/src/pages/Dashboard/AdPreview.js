...
const getCountryByVal = (value) => {
  ...
  // Return null or any other default value if the value is not found
  return null;
};
      ...
      <Box>
        ...
        >
          ...
          <Typography fontSize={{ xs: 18, sm: 20, lg: 24 }}>
            {data.advertiser_name.length > 40
              ? data.advertiser_name.substring(0, 40) + "..."
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} lg={7}>
              ...
              >
                ...
                >
                  {more ? data.body : `${data.body.substring(0, 200)}...`}
                </Typography>
                <Box
                  sx={{
                    display: "flex",
            ...
            <Grid item xs={12} lg={5}>
              ...
              <Stack spacing={1} direction={"column"} sx={{}}>
                ...
                >
                  ...
                  <Box>
                    <Typography fontSize={14}>{getOSValue(data.os)}</Typography>
                  </Box>
                </Box>
                <Box
                  sx={{
