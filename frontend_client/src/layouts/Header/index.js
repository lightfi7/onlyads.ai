...
const pages = [{ title: "Ads", href: "/ads", role: ["user"] }];

const pages2 = [
  { title: "Products", href: "/products", role: ["user"] },
  { title: "Top Products", href: "/top-products", role: ["user"] },
  { title: "Top Stores", href: "/top-stores", role: ["user"] },
];

const pages4 = [
  { title: "Hot", href: "/nexus-hot", role: ["user"] },
  { title: "Trending", href: "/nexus-trending", role: ["user"] },
  { title: "On The Rise", href: "/nexus-rise", role: ["user"] },
  { title: "New", href: "/nexus-new", role: ["user"] },
